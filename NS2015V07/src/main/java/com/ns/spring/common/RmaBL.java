...
public class RmaBL implements RtrnConstant {
	...
	public static List<RmaHdrModel> getRmaHdrListWCdTblNm(HttpServletRequest req) {
	...
	public static RmaHdrModel getRmaHdrModel(String rmaNum) {
		List<RmaHdrModel> rmaHdrModelList = getRmaHdrListWithCdTblNm(rmaNum);
		return rmaHdrModelList.get(0);
	}

	public static List<RmaHdrModel> getRmaHdrListWithCdTblNm(String rmaNum) {
